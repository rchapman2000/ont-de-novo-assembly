...
process Setup {
    ...
    The parameters file contains:
        ...
        2. The minimum read length cutoff (if supplied).
        3. The maximum read length cutoff (if supplied).
        4. The medaka model provided.
        5. The batch size parameter provided to medaka.
...
process Flye_Assembly {
    ...
    publishDir "${outDir}", mode: 'copy', pattern: "${base}-draft-assembly.fasta"
    publishDir "${outDir}/${base}-Intermediate-Files/", mode: 'copy', pattern: "${base}-flye.zip"
